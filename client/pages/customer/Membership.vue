                    ...
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      >
                        <h3 class="r-heading-light r-text-white r-text-uppercase">
                          Meet Spazaland<span class="r-text-primary">+</span>
                        </h3>
                      </a-col>
                      <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                             :sm="{ span: 24 }"
                      ...
                      >
                        <p class="r-text-medium">
                          Get the benefits of Spazaland+ with every purchase you make
                        </p>
                      </a-col>
                      <a-col :lg="{ span: 12 }" :md="{ span: 12 }"
                             :sm="{ span: 24 }"
              ...
              <template slot="description">
                <a-row :gutter="[96,48]" align="middle" justify="start" type="flex">
                  ...
                  >
                    <a-row :gutter="[24,24]" align="top" justify="start" type="flex">
                      ...
                      >
                        ...
                        >two-day</span> shipping on items from Spazaland.
                        </h3>
                      </a-col>
                      <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                             :sm="{ span: 24 }"
                  ...
                  <a-col :lg="{ span: 12 }" :md="{ span: 12 }"
                         ...
                         :xs="{ span: 24 }"
                  >
                    <r-avatar :dataSrc="'/images/content/screen-02-secondary.png'" :size="300" class="r-avatar-block"
                    ></r-avatar>
                  </a-col>
                </a-row>
              </template>
              ...
              <template slot="description">
                <a-row :gutter="[96,48]" align="middle" justify="start" type="flex">
                  <a-col :lg="{ span: 12 }" :md="{ span: 12 }"
                         ...
                         :xs="{ span: 24 }"
                  >
                    <r-avatar :dataSrc="'/images/content/screen-01-secondary.png'" :size="300" class="r-avatar-block"
                    ></r-avatar>
                  </a-col>
                  <a-col :lg="{ span: 12 }" :md="{ span: 12 }"
                         :sm="{ span: 24 }"
              ...
              <a-row :gutter="[24,24]" align="middle" justify="center" type="flex">
                ...
                >
                  <h3 class="r-heading-light r-text-uppercase">
                    Why <span class="r-text-primary">Spazaland+</span> For Retailers?
                  </h3>
                </a-col>
  ...
  data () {
    return {
      features: [
        ...
        { content: 'Items shipped by Spazaland shoppers for free' }
      ],
      benefits: [
