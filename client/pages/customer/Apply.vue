      ...
      <a-form v-if="hasForm" class="ant-form ant-form-vertical"
        ...
        <a-form-item v-if="step == 0">
          ...
          <a-row type="flex" justify="start">
            <a-col class="gutter-row r-text-left" :xs="{ span: 24 }">
              ...
              <p class="r-text-normal">
                Kshopit is a fast growing startup that is improving lives by giving people more time to
                spend
                with their families! Our Kshopit members order shopping via the Kshopit app and can have
                them
          ...
          <a-row type="flex" justify="start">
            <a-col class="gutter-row r-text-left" :xs="{ span: 24 }">
              <h3 class="r-heading">
                What is a Kshopit shopper?
              </h3>
              <p class="r-text-normal">
                Our Kshopit Shoppers carefully select member's shopping using the Kshopit app and deliver
                them
        ...
        <a-form-item v-if="step == 2">
          ...
          <p class="r-text-normal">
            By entering your email addrress and mobile number you are opting in to receive automated Kshopit
            Application
          ...
          <a-row type="flex" justify="start">
            ...
            <a-col class="gutter-row r-text-right" :xs="{ span: 12 }" :sm="{ span: 12 }" :lg="{ span: 12 }">
              <a-button @click="onStep"
                        ...
                        class="ant-btn ant-btn-secondary r-btn-secondary">
