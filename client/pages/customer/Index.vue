<template>
  <a-row :gutter="[96,96]" justify="center" type="flex">
          ...
          <a-card class="r-bg-primary-light r-pull-h-24 r-border-none">
            <div class="r-mv-48">
              <a-row :gutter="[48,48]" justify="center" type="flex">
                        ...
                        <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                          ...
                          >
                            <h3 class="r-heading-light r-text-uppercase">
                              <span class="r-text-primary">For</span>
                              <span class="r-text-dark">Retailers</span>
                            </h3>
                          </a-col>
                          <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                                 :sm="{ span: 24 }"
                          ...
                          >
                            <h1 class="r-heading">
                              A B2B <span class="r-text-secondary">marketplace</span> for farmers and buyers.
                            </h1>
                          </a-col>
                          <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                                 :sm="{ span: 24 }"
                          ...
                          >
                            <p class="r-text-medium">
                              Spazaland is the leading product discovery and sourcing platform where retailers and
                              suppliers discover, connect, and grow their business.
                            </p>
                          </a-col>
                          <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                                 :sm="{ span: 24 }"
                          ...
                          >
                            <p class="r-text-normal">
                              Join the Spazaland farmers's platform and start purchasing high-quality products directly from
                              farmers.
                            </p>
                          </a-col>
                ...
                <a-col :lg="{ span: 12 }" :md="{ span: 12 }" :sm="{ span: 24 }" :xs="{ span: 24 }">
                  <r-avatar data-src="/assets/asset-08.svg" :size="300" class="r-avatar-block"
                  ></r-avatar>
                </a-col>
              </a-row>
            </div>
    ...
    <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
           ...
           :xs="{ span: 24 }"
    >
      <a-row :gutter="[0,0]" align="middle" justify="center" type="flex">
        <a-col :lg="{ span: 24 }" :md="{ span: 24 }" :sm="{ span: 24 }"
               :xs="{ span: 24 }"
               class="r-text-center"
        >
    ...
    <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
           ...
           :xs="{ span: 24 }"
    >
      <a-card class="r-bg-white r-pull-h-24 r-border-none r-box-shadow">
              ...
              <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                ...
                >
                  <h3 class="r-heading">
                    ...
                    world's leading retailers and food outlets
                  </h3>
                </a-col>
                <a-col :lg="{ span: 24 }" :md="{ span: 24}"
                       :sm="{ span: 24 }"
