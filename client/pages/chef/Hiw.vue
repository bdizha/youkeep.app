                    ...
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      >
                        <p class="r-text-medium">
                          Get the benefits of the Spazastop platform at a price you can afford and enjoy the best return on investment (ROI) on the market.
                        </p>
                      </a-col>
                      <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                             :sm="{ span: 24 }"
                      ...
                      >
                        <p class="r-text-normal">
                          With an online business platform, millions of shoppers, and tons of selling tools on Spazastop, it’s the all-in-one
          ...
          <a-row :gutter="[24,24]" align="middle" justify="center" type="flex">
            ...
            >
              <a-row :gutter="[24,24]" align="middle" justify="center" type="flex">
                ...
                >
                  <h3 class="r-heading-light r-text-primary r-text-uppercase">
                    Why <span class="r-text-white">Sell</span> online at Spazastop?
                  </h3>
                </a-col>
                ...
                >
                  <h2 class="r-heading">
                    Spazastop <span class="r-text-primary">makes</span> Your categories visible to millions of shoppers.
                  </h2>
                </a-col>
                ...
                >
                  <p class="r-text-medium">
                    That's because Spazastop is seamlessly integrated into your realtime catalog and your money shows up
                    in your Spazastop account with every sale.
                  </p>
                </a-col>
                <a-col :lg="{ span: 18 }" :md="{ span: 12 }"
                       :sm="{ span: 24 }"
