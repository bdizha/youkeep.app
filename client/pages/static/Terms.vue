    ...
    <a-row class="r-margin-vertical-48" type="flex"
      ...
      <a-col :xs="{span: 24}" :sm="{span: 18}" :md="{span: 16}" :lg="{span: 12}">
        <article class="r-article">
          <p>Thank you for using Kshop!</p>
          <p><strong>PLEASE READ THE FOLLOWING TERMS AND CONDITIONS (THE “TERMS”) CAREFULLY BEFORE
            USING OUR WEBSITE, www.Kshop.com, OR OUR MOBILE APPLICATIONS (COLLECTIVELY, THE
            “SITE”).</strong></p>
          ...
          <p>To cancel your membership, please contact Kshop HQ via <a class="text-bold"
                                                                       href="https://web.archive.org/web/20181025162846/mailto:support@Kshop.com">support@Kshop.com</a>
          ...
          <p>You may have the option to order delivery of alcohol products in some locations and from
            certain retailers. You will not use Kshop to order alcohol products unless you are 21
            years of age or older and you will not furnish alcohol products obtained through Kshop
            to any person who is not a lawful consumer. You agree that you will comply with all
            applicable laws related thereto and not cause Kshop, your Shopper, or any retailer to
            contravene or violate any applicable law. Kshop may offer information and a method to
            connect duly licensed, participating retailers to you to purchase alcohol beverages.
            Kshop does not, and does not intend to, make sales of alcohol beverages. Each
            participating retailer is the seller of record for the particular products it promotes
            on Kshop and sells to you. Kshop HAS NO RESPONSIBILITY OR LIABILITY FOR (I) ANY SALE OF
            ...
            CONSUMPTION OF ALCOHOL PRODUCTS PROMOTED OR ACQUIRED THROUGH Kshop.</p>
          ...
          <p>The Site and the content of the Site including, but not limited to, text, graphics,
            images, audio clips, digital downloads, data compilation or code is owned by Kshop, its
          ...
          <p>These Terms permit you to use the Site for your personal, non-commercial use only.
            Subject to these Terms, Kshop grants you a limited, non-exclusive, non-transferable
          ...
          <ol>
            ...
            <li>Engage in any other conduct that restricts or inhibits anyone’s use or enjoyment of
              the Site, or which, as determined by us, may harm Kshop or users of the Site or
              expose them to liability.
            </li>
          </ol>
          <p>All trademarks, service marks and trade names of Kshop on the Site are trademarks or
            registered trademarks of Kshop or their respective owners. You may not use such marks
            without Kshop’s or the respective owner’s prior written consent or as provided below in
          ...
          <p>You acknowledge and agree that the Site is provided under a license, and not sold, to
            ...
            other rights thereto other than to use the Site in accordance with these Terms. Kshop
          ...
          <p>Through your use of the Site, you may be able to submit, upload, publish or otherwise
            make available to Kshop textual, audio and/or visual content, including commentary and
            feedback (the “Content”). As between you and Kshop, any Content that you provide remains
            your property. However, by providing Content to Kshop, you grant Kshop and all of its
          ...
          <p>The Site may link to other websites operated by third parties. We have no control over
            ...
            independent of Kshop. We are not responsible for, do not endorse and do not accept any
          ...
          <p>By registering to become a member, you agree that we may send you text (SMS) messages in
            ...
            opt-out of receiving text (SMS) messages from Company at any time by contacting Kshop HQ
            via support@Kshop.com, provided however that opting out of text (SMS) messages may
          ...
          <p>Kshop respects the intellectual property rights of others and has implemented a copyright
            policy in accordance with the Digital Millennium Copyright Act (“DMCA”). If you believe
            that any content on the Site violates your copyright, please send Kshop a written notice
          ...
          <ol>
            <li>A description of the claimed infringing material as well as identification of the
              claimed infringing material, including the location of such material on the Kshop
          ...
          <p>We may terminate your use of the Site and the services offered on the Site at any time,
            for any reason and Kshop may prohibit your use of the Site and services offered on the
          ...
          <h4>Credits</h4>
          <p>
            <a href="https://web.archive.org/web/20181025162846/http://credits.Kshop.com/">credits.Kshop.com</a>
          </p>
          ...
          <p>EXCEPT AS OTHERWISE SPECIFICALLY PROVIDED HEREIN, THE SITE AND THE PRODUCTS AND SERVICES
            ...
            WARRANTIES OF ANY KIND. TO THE FULLEST EXTENT PERMISSIBLE UNDER APPLICABLE LAW, Kshop
            DISCLAIMS ALL WARRANTIES, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO,
            IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND
            NON-INFRINGEMENT. Kshop DOES NOT REPRESENT OR WARRANT THAT THE SITE AND FEATURES AND
            ...
            FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. Kshop DOES NOT MAKE ANY WARRANTIES OR
          ...
          <p>Kshop SHALL NOT BE LIABLE TO ANYONE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL OR
            ...
            SITE OR MATERIALS ON THE SITE, EVEN IF Kshop HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH
            DAMAGES. Kshop WILL NOT BE LIABLE FOR ANY LOSS, DAMAGE OR INJURY WHICH MAY BE INCURRED
            BY YOU, INCLUDING BUT NOT LIMITED TO LOSS, DAMAGE OR INJURY ARISING OUT OF, OR IN ANY
            WAY CONNECTED WITH THE SITE OR Kshop’S SERVICES, ANY RELIANCE PLACED BY YOU ON THE
            ...
            OR SPONSOR. IN NO EVENT SHALL Kshop’S AGGREGATE LIABILITY TO YOU OR ANY THIRD PARTY
          ...
          <p>Kshop MAY INTRODUCE YOU TO SHOPPERS FOR THE PURPOSES OF PROVIDING COURIER SERVICES. YOU
            EXPRESSLY WAIVE AND RELEASE Kshop FROM ANY AND ALL LIABILITY, CLAIMS OR DAMAGES ARISING
            FROM OR IN ANY WAY RELATED TO THE SHOPPERS. Kshop WILL NOT BE A PARTY TO DISPUTES
          ...
          <p>You agree to indemnify, defend and hold harmless Kshop, its officers, directors,
          ...
          <p>These Terms, along with any rules, guidelines or policies published in the Site
            constitute the entire agreement between Kshop and you with respect to your use of the
            ...
            obligation under these Terms without the prior consent of Kshop. Kshop’s failure to
            ...
            do not limit any rights that Kshop may have pursuant to any intellectual property laws
            or other laws. All rights and remedies available to Kshop, pursuant to these Terms or
