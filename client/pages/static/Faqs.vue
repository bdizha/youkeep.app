          ...
          >
            <a-row :gutter="[96,96]" align="middle" justify="start" type="flex">
                    ...
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      >
                        <p class="r-text-normal">
                          Graphigem aims for accuracy and transparency in both our books and how our service works. If
              ...
              <a-col :lg="{ span: 12 }" :md="{ span: 12 }"
                     ...
                     :xs="{ span: 24 }"
              >
                <r-avatar :dataSrc="'/images/content/6.png'" :size="600" class="r-avatar-block"
                ></r-avatar>
              </a-col>
            </a-row>
          </a-col>
...
export default {
  ...
  data () {
    return {
      features: [
        { content: 'Access Graphigem via desktop or iPhone - we go where you go' },
