    ...
    <a-row class="r-mv-48" type="flex"
      ...
      <a-col :xs="{span: 24}" :sm="{span: 18}" :md="{span: 16}" :lg="{span: 12}">
        <article class="r-article">
          <p>Thank you for using Shopple! This privacy policy has been compiled to better serve those
          ...
          <p>We receive, store and process information, including personally identifiable information,
            that you make available to us when accessing or using the Shopple Platform and Services.
          ...
          <ul>
            <li>fill in any form on the Platform, such as when you register or update the details of
              your user account, or when you supply ID and other verification information;
            </li>
            ...
            <li>communicate with Shopple.</li>
          </ul>
          ...
          <p>Cookies, Pixels, and Other Tracking Technologies: We and our partners use various
            technologies to collect information, including cookies, pixels, and device identifiers.
            Cookies are small text files that are sent by your computer when you access our services
            through a browser. We may use session cookies (which expire when you close your
            browser), persistent cookies (which expire when you choose to clear them from your
          ...
          <p>Mobile Data: When you use certain features of the Platform, in particular our mobile
            ...
            information (e.g. GPS-based functionality on mobile devices used to access the Platform
            or specific features of the platform). If you access the Platform through a mobile
            device and you do not want your device to provide us with location-tracking information,
            ...
            further details.</p>
          <p>We employ some third-party services to help us understand the usage of Shopple, and these
          ...
          <p>Log information: When you use Shopple, our servers will record information about your usage
            ...
            navigate to and links that you click, searches that you run on Shopple, and other ways you
            interact with the service. When you are logged into the Shopple service, this information
          ...
          <ul>
            <li>To support the buying and selling process, we collect the personal information you
              give us such as your name, address and email address. This information will be
              stored and used to process and fulfill your orders.
            </li>
            <li>We may provide personal information to the merchants who fulfill the orders you
              place on our sites.
            </li>
            <li>We may share personal information with our subsidiaries, affiliates and marketing
              partners.
            </li>
            <li>We may share aggregated, anonymized or de-identified personal information with any
              third party, without any restriction, including through the use of cookies and other
              automated technologies.
            </li>
            <li>To operate, protect, improve and optimize the Platform, Shopple’s business and our
            ...
            <li>To send you marketing, advertising, and promotional messages and other information
              that may be of interest to you, including information about Shopple, our services, or
            ...
            <li>To administer referral programs, rewards, surveys, sweepstakes, contests, or other
              promotional activities or events sponsored or managed by Shopple or our Third Party
              business partners.
            </li>
          </ul>
          ...
          <p>In general, the third-party providers used by us will only collect, use and disclose your
            ...
            to us.</p>
          <p>However, certain third-party service providers, such as payment gateways and other
            ...
            providers.</p>
          <p>In particular, remember that certain providers may be located in or have facilities that
            are located a different jurisdiction than either you or us. So if you elect to proceed
            with a transaction that involves the services of a third-party service provider, then
            your information may become subject to the laws of the jurisdiction(s) in which that
            service provider or its facilities are located.</p>
          <p>As an example, if you are a Canadian citizen and your transaction is processed by a
            ...
            legislation, including the Patriot Act.</p>
          <p>This privacy policy does not apply to information collected by any third party, including
            through any application or content (including advertising) that may link to or be
            accessible from our site.</p>
          <h2>Disclosure</h2>
          <p>We may disclose your personal information if we are required by law to do so or if you
            violate our Terms of Service.</p>
          <h2>Links</h2>
          <p>When you click on links on our website or blog, they may direct you away from our site.
            We are not responsible for the privacy practices of other sites and encourage you to
            read their privacy statements.</p>
          <h2>Security</h2>
          <p>To protect your personal information, we take reasonable precautions and follow industry
            ...
            disclosed, altered or destroyed.</p>
          <p>If you provide us with your credit card information, the information is encrypted using
            secure socket layer technology (SSL) and stored with AES-256 encryption. &nbsp;Although
          ...
          <p>Residents of the State of California, under the California Civil Code, have the right to
            ...
            which Shopple has disclosed personal information during the preceding year for direct
            ...
            company may instead provide you with information on how to exercise your disclosure
            choice options.</p>
          <p>This site qualifies for the alternative option. Its privacy policy provides you with
            information on how you may opt-out from the use of your personal information by third
            parties for direct marketing purposes. Therefore, we are not required to maintain or
            disclose a list of the third parties that received your personal information during the
          ...
          <p>The site is not intended for children under 13 years of age. No one under age 13 may
            provide any information through the site. If you are under 13, do not use or provide any
            information through the site or on or through any of its features. We do not knowingly
            collect personal information from children under 13; however, if we learn we have
            collected or received personal information from a child under 13 without verification of
            parental consent, we will delete that information. Please contact us if you believe we
            might have personal information about a child under age 13.</p>
          ...
          <p>If Shopple is acquired or merged with another company, your information may be transferred
