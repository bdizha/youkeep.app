                    ...
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      >
                        <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                          ...
                          >
                            <h1 class="r-heading">
                              Partner with Youkeep for venture catalyst services you can leverage on.
                            </h1>
                          </a-col>
                          <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                                 :sm="{ span: 24 }"
                          ...
                          >
                            <p class="r-text-normal">
                              ...
                              books? Youkeep can produce years of outstanding businesses quickly, so you can focus
              ...
              <a-row :gutter="[24,24]" align="middle" class="r-text-left" justify="center" type="flex">
                ...
                >
                  <a-row :gutter="[24,24]" align="middle" class="r-text-left" justify="center" type="flex">
                    ...
                    >
                      <p class="r-text-normal">
                        Youkeep’s mission is to bring the best marketplace tools directly to the sellers.
                        Finances
                        should always be
      ...
      <a-row align="middle" justify="start" type="flex">
        ...
        >
          <a-row align="middle" justify="start" type="flex">
            ...
            >
              <h1 class="r-heading">
                <span class="r-text-secondary">Youkeep careers</span>
              </h1>
              <p class="r-text-normal">
                Youkeep is a shopper centric business platform that exists to transform
          ...
          <a-row :gutter=[24,24] justify="center" type="flex">
            <a-col :lg="{ span: 12 }" :sm="{ span: 12 }" :xs="{ span: 24 }" class="r-p-48">
              ...
              <p class="r-text-normal">
                ...
                big, and play well.
                And we do it together, because at the Mother Youkeep, we’re family.
              </p>
              <p class="r-text-normal">
                Nothing great has ever been built in a day, and it definitely wasn’t built in a flash.
                At Youkeep, we’re building something great, something unimaginable at this juncture. We
                provide our service as a token of appreciation to the society that serves us.
              </p>
            </a-col>
            <a-col :lg="{ span: 12 }" :sm="{ span: 12 }" :xs="{ span: 24 }" class="r-p-48">
              <h2 class="r-heading r-text-secondary">
                Why work with Youkeep?
              </h2>
              <a-row align="middle" class="r-mb-48" justify="start" type="flex">
                <a-col :span="24">
