                      ...
                      <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                        ...
                        >
                          <h3 class="r-heading-light r-text-primary r-text-uppercase">
                            Youkeep <span class="r-text-primary">Capital</span>
                          </h3>
                        </a-col>
                        <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                               :sm="{ span: 24 }"
                        ...
                        >
                          <p class="r-text-normal">
                            We enable your product to reach the customer with the help of our team's experiences of
                            running
          ...
          <a-row :gutter="[24,24]" align="middle" class="r-text-center" justify="center" type="flex">
            ...
            >
              <h2 class="r-heading-light">
                <span class="r-text-orange">Innovate</span> <span class="r-text-orange">alongside</span> Youkeep.
              </h2>
            </a-col>
            <a-col :lg="{ span: 15 }" :md="{ span: 16 }"
                   :sm="{ span: 24 }"
            ...
            >
              <p class="r-text-normal">
                We are enabling African businesses to have access to financial and expert resources needed to
                succeed.
              </p>
            </a-col>
          </a-row>
      ...
      <a-row class="r-text-center" :gutter="[48,48]" align="middle" justify="center" type="flex">
        ...
        >
          <a-row class="r-text-center" :gutter="[24,24]" align="middle" justify="center" type="flex">
            ...
            >
              <p class="r-text-normal">
                Over 20 years we have developed deep in-house expertise in several overlapping domains, which helps
                us
