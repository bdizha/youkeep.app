  ...
  <a-row :gutter="[48,96]" align="middle" justify="center" type="flex">
                    ...
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      >
                        <p class="r-text-medium">
                          Earn up to R55/hr or more business for Brickcent members.
    ...
    >
      <a-row :gutter="[24,24]" class="r-text-center" justify="center" type="flex">
        ...
        <a-col :lg="{ span: 16 }" :sm="{ span: 24 }" :xs="{ span: 24 }">
          <p class="r-text-medium">
            With Brickcent, you don’t have to worry about which store to go to or where your next ride will take you.
          </p>
        </a-col>
        <a-col :lg="{ span: 24 }" :sm="{ span: 24 }" :xs="{ span: 24 }">
            ...
            <a-card-meta>
              <template slot="description">
                <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                  ...
                  <a-col :lg="{ span: 24 }" :sm="{ span: 24 }" :xs="{ span: 24 }">
                    <p class="r-text-normal">
                      Brickcent is a membership-based business marketplace, enabling delivery of trendy fashion items,
    ...
    return {
      ...
      features: [
        ...
        },
        {
          ...
          content: 'Experienced shoppers make an average of R45/hr. Your weekly earnings are automatically credited to your Brickcent account on your set payment day.',
