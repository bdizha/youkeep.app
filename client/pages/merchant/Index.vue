                    ...
                    <a-row :gutter="[24,24]" justify="center" type="flex">
                      ...
                      >
                        <p class="r-text-medium">
                          <span class="r-text-primary">36%</span> increase in online and in-store sales with Spazamall+ and more payment options.
                        </p>
                      </a-col>
                      <a-col :lg="{span: 24}" :md="{ span: 24 }" :sm="{ span: 24 }" :xs="{ span: 24 }"
                             class="r-text-left"
                ...
                <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                  ...
                  >
                    <a-row :gutter="[24,24]" justify="center" type="flex">
                      ...
                      >
                        <p class="r-text-medium">
                          <span class="r-text-primary">24%</span> of Spazamall shoppers use their existing credit card to pay over time at no cost.
                        </p>
                      </a-col>
                      <a-col :lg="{span: 24}" :md="{ span: 24 }" :sm="{ span: 24 }" :xs="{ span: 24 }"
                             class="r-text-left"
                ...
                <a-row :gutter="[24,24]" align="top" justify="start" type="flex">
                  ...
                  >
                    <a-row :gutter="[24,24]" justify="center" type="flex">
                      ...
                      >
                        <p class="r-text-medium">
                          <span class="r-text-primary">42%</span> of shoppers are more likely to make a purchase if offered the freedom of choice.
                        </p>
                      </a-col>
                      <a-col :lg="{span: 24}" :md="{ span: 24 }" :sm="{ span: 24 }" :xs="{ span: 24 }"
                             class="r-text-left"
