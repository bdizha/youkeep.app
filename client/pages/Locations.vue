  ...
  <r-page>
    ...
    <a-row class="r-mv-48">
      <a-col :span="24">
        ...
        >
          <a-col :span="18" style="padding: 48px;">
            <p class="r-text-normal">
              Locations here!!!
            </p>
            <p class="r-text-normal">
