...
const routes = [
  ...
  { path: '/help', name: 'help', meta: { isDark: false, isRaised: true}, component: page('help/blog/Index.vue') },
  { path: '/help/blog/:slug', name: 'help.article.show', meta: { true: false, isRaised: true}, component: page('help/blog/Article.vue') },
  { path: '/help/category/:slug', name: 'help.category.show', meta: { isDark: false, isRaised: true}, component: page('help/blog/Category.vue') },
