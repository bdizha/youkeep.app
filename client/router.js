...
const routes = [
  ...
  { path: '/shopper/hiw', name: 'shopper-paise', component: page('shopper/Auto.vue') },
  ...
  { path: '/seller/hiw', name: 'seller-paise', component: page('seller/Auto.vue') },
  ...
  { path: '/hiw', name: 'hiw', component: page('static/Auto.vue') },
