...
const routes = [
  ...
  { path: '/seller/hiw', name: 'seller-paise', meta: { isDark: false, isRaised: false}, component: page('seller/Auto.vue') },
  { path: '/seller/resources', name: 'resource', meta: { isDark: false, isRaised: false}, component: page('resource/Index.vue') },
  { path: '/seller/resource/:slug', name: 'resource-show', meta: { isDark: false, isRaised: false}, component: page('resource/Show.vue') },
  ...
  { path: '/invest', name: 'invest', meta: { isDark: false, isRaised: false}, component: page('static/Invest.vue') },
  {
    path: '/settings',
