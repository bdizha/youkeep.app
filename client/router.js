...
const routes = [
  ...
  { path: '/buyer', name: 'customer', meta: { isDark: true, isRaised: false}, component: page('customer/Index.vue') },
  ...
  { path: '/supplier/resource/:slug', name: 'resource-show', meta: { isDark: false, isRaised: false}, component: page('resource/Show.vue') },
  ...
  { path: '/product', name: 'products', meta: { isDark: false, isRaised: true}, component: page('product/Index.vue') },
  { path: '/product/:slug', name: 'product-show', meta: { isDark: false, isRaised: true}, component: page('product/Show.vue') },
  {
    path: '/settings',
