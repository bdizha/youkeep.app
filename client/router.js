...
const routes = [
  ...
  { path: '/help', name: 'help', meta: { isDark: false, isRaised: true}, component: page('blog/Index.vue') },
  { path: '/help/article/:slug', name: 'help.article.show', meta: { true: false, isRaised: true}, component: page('blog/Article.vue') },
  { path: '/help/category/:slug', name: 'help.category.show', meta: { isDark: false, isRaised: true}, component: page('blog/Category.vue') },
