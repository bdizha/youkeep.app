...
const routes = [
  {path: '/', name: 'index', component: page('list.vue')},
  ...
  {path: '/shopper', name: 'shopper', component: page('shopper/list.vue')},
  {path: '/shopper/paise', name: 'shopper-paise', component: page('shopper/Paise.vue')},
  {path: '/customer', name: 'customer', component: page('customer/list.vue')},
  {path: '/customer/paise', name: 'customer-paise', component: page('customer/Paise.vue')},
  {path: '/merchant', name: 'merchant', component: page('merchant/list.vue')},
  {path: '/merchant/paise', name: 'merchant-paise', component: page('merchant/Paise.vue')},
  {path: '/merchant/resources', name: 'resource', component: page('resource/list.vue')},
  {path: '/merchant/resource/:slug', name: 'resource-show', component: page('resource/Show.vue')},
  {path: '/stores/:category', name: 'stores', component: page('store/list.vue')},
  ...
  {path: '/help', name: 'help', component: page('help/list.vue')},
  {path: '/help/:id/:slug', name: 'help.show', component: page('help/Show.vue')},
  {path: '/careers', name: 'careers', component: page('career/list.vue')},
  ...
  {
    path: '/settings',
    component: page('settings/list.vue'),
    children: [
