...
const routes = [
  ...
  {path: '/store/:store/category/:category/:level', name: 'store.category.show.level', component: page('store/Category.vue')},
  ...
  {path: '/category/:slug/:level', name: 'category.show.level', component: page('store/Category.vue')},
