            ...
            <a-row justify="center" type="flex">
              <a-col :xs="{ span: 24 }" class="r-text-left">
                ...
                <p class="r-text-small">
                  Enter and confirm new credentials to secure your Graphigem account.
                </p>
              </a-col>
            </a-row>
          </a-form-item>
...
export default {
  ...
  data () {
    return {
      ...
      message: 'Thank you for successfully securing your Graphigem account! Please wait while we setup your account.',
      userType: 1,
    }
  },
  computed: mapGetters({
