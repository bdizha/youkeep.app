            ...
            <a-row :gutter=[24,24] justify="center" type="flex">
              <a-col :xs="{ span: 24 }" class="r-text-left">
                ...
                <p class="r-text-small">
                  Enter and confirm new credentials to secure your Spazaland account.
                </p>
              </a-col>
            </a-row>
          </a-form-item>
...
export default {
  ...
  data () {
    return {
      ...
      message: 'Thank you for successfully securing your Spazaland account! Please wait while we setup your account.',
      userType: 1,
    }
  },
  computed: mapGetters({
  ...
  methods: {
    ...
    async onSecure (params) {
      ...
      await this.$store.dispatch('auth/onPost', payload).catch(error => {
        ...
        setTimeout(() => {
          if ($this.isValid) {
            $this.$message.success('Thank you, your account is now secured. Enjoy your business with Spazaland.')
          } else {
