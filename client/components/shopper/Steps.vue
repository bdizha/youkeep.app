      ...
      steps: [
        {
          ...
          content: 'Youkeep enables Shoppers to create a universal account and buy from dozens of retailers in a few seconds.'
        },
        {
          ...
          summary: 'With Youkeep, users no longer need to pull out their credit card or enter long forms to complete online purchases.',
        ...
        },
        {
          ...
          heading: '<span class="r-text-primary">Pay</span> in 3 installments with Youkeep.',
