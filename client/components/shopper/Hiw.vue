      ...
      <a-row align="middle" justify="start" type="flex">
        ...
        >
          <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
            ...
            >
              <h2 class="r-heading">
                Why millions of shoppers <span class="r-text-secondary">choose</span> Addtract
              </h2>
            </a-col>
                  ...
                  <template slot="description">
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      <a-col :lg="{ span: 16 }" :md="{ span: 16 }" :sm="{ span: 24 }" :xs="{ span: 24 }">
                        Perfectly categorized and reconciled transactions come standard
                      </a-col>
                    </a-row>
                  </template>
                </a-card-meta>
                ...
                <a-card-meta>
                  <template slot="description">
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      <a-col :lg="{ span: 16 }" :md="{ span: 16 }" :sm="{ span: 24 }" :xs="{ span: 24 }">
                        Our Client Research Team tackles complex questions and is 100% free
                      </a-col>
                    </a-row>
                  </template>
                </a-card-meta>
              ...
              <template slot="description">
                <a-row :gutter="[96,48]" align="middle" justify="start" type="flex">
                    ...
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      >
                        <a-row :gutter="[24,24]" align="top" justify="start" type="flex">
                          ...
                          >
                            <h3 class="r-heading">
                              Addtract <span class="r-text-secondary">gives</span> you the flexibility to <span
                  ...
                  <a-col :lg="{ span: 12 }" :md="{ span: 12 }"
                         ...
                         :xs="{ span: 24 }"
                  >
                    <r-avatar :size="300" class="r-avatar-block" data-src="/images/content/screen-02-primary.png"
                    ></r-avatar>
                  </a-col>
                </a-row>
              </template>
              ...
              <template slot="description">
                <a-row :gutter="[96,48]" align="middle" justify="start" type="flex">
                  <a-col :lg="{ span: 12 }" :md="{ span: 12 }"
                         ...
                         :xs="{ span: 24 }"
                  >
                    <r-avatar :size="300" class="r-avatar-block" data-src="/images/content/screen-01-primary.png"
                    ></r-avatar>
                  </a-col>
                  <a-col :lg="{ span: 12 }" :md="{ span: 12 }"
                         :sm="{ span: 24 }"
                    ...
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      >
                        <a-row :gutter="[24,24]" align="top" justify="start" type="flex">
                          ...
                          >
                            <h3 class="r-heading">
                              Addtract is the best way to <span class="r-text-secondary">find</span> and <span
                              class="r-text-secondary"
                          ...
                          >
                            <p class="r-text-medium">
                              Addtract partners with trusted and local stores that ensures faster deliveries in less
                          ...
                          >
                            <p class="r-text-normal">
                              Addtract is created to offer you the best
