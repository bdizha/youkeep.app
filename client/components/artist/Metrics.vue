  ...
  <a-row :gutter="[24,24]" align="middle" class="r-text-center" justify="center" type="flex">
    ...
    >
      <p class="r-text-medium">
        Youkeep is the leading product discovery and sourcing platform where retailers and artists discover, connect, and grow their business.
      </p>
    </a-col>
    <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
           :sm="{ span: 24 }"
