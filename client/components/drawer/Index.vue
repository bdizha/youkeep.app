<template>
    <a-drawer
        ...
        <transition-group name="fade" tag="div">
            ...
            <r-store-left-drawer v-if="isCurrent('store-left')"
                                 v-bind:key="'category'" class="fade-item"></r-store-left-drawer>
            <r-store-right-drawer v-if="isCurrent('store-right')"
                                  v-bind:key="'category'" class="fade-item"></r-store-right-drawer>
        </transition-group>
    </a-drawer>
</template>
<script>
