              ...
              <a-row :gutter=[24,24] justify="center" type="flex">
                <a-col :xs="{ span: 24 }">
                  <p class="r-text-light">
                    You will be charged a Professional selling subscription fee of 159.99 ZAR for the first month. You
                    will continue to be charged this fee each month if you have active listings. If you do not have
                    active listings, you will not be charged a subscription fee in that month. If you expand to sell in
                    other stores, you will pay the equivalent of 39.99 USD per month, split proportionately across each
                    country or region in which you have an active listing and charged separately in each local currency.
                    You can downgrade at any time. For more information, see this page.
                  </p>
                </a-col>
              </a-row>
            </a-form-item>
