        ...
        <a-form-item v-if="step == 0">
          ...
          <a-row align="middle" justify="start" type="flex">
            <a-col :xs="{ span: 24 }" class="r-text-left">
              ...
              <p class="r-text-normal">
                ...
                spend
                with their families! Our Shopple members order business via the Shopple app and can have
                them
          ...
          <a-row align="middle" justify="start" type="flex">
            <a-col :xs="{ span: 24 }" class="r-text-left">
              ...
              <p class="r-text-normal">
                Our Shopple Shoppers carefully select member's business using the Shopple app and deliver
                them
