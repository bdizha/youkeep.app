<template>
  <r-page>
                ...
                >
                  <a-row align="middle" justify="start" type="flex">
                    ...
                    >
                      ...
                      <p class="r-text-normal">
                        We’ll ship you an activation kit to promote Shopple online.
                      </p>
                    </a-col>
                  </a-row>
                  <a-row align="middle" justify="start" type="flex">
            ...
            <a-row align="middle" class="r-margin-vertical-24" justify="start" type="flex">
              ...
              >
                <h4 class="r-heading-light">
                  Customers want to buy more of Your catalog. And now they've a more
                  flexible
                  business option with Shopple
                </h4>
              </a-col>
            </a-row>
    ...
    <r-steps :has-title="true" :has-wave="false" heading="Shopple business experience"></r-steps>
      ...
      >
        <a-row justify="center" type="flex">
          <a-col :lg="{ span: 12 }" :sm="{ span: 12 }" :xs="{ span: 24 }" class="r-padding-vertical-48">
            ...
            <p class="r-text-normal">
              Join the Shopple Merchant Program and start promoting Shopple online today and watch your
              business run wild!
            </p>
          </a-col>
        </a-row>
        <a-row align="middle" justify="center" type="flex">
          ...
          >
            <a-button size="large" type="secondary" @click="onModal('merchant')">
              Become a Merchant
            </a-button>
          </a-col>
        </a-row>
