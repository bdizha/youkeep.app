              ...
              >
                <a-row :gutter="[24,24]" align="middle" justify="center" type="flex">
                      ...
                      <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                        ...
                        >
                          <p class="r-text-normal">
                            Shopple empowers the whole startup experience for businesses in Africa. We specialize in
                  ...
                  <a-col :lg="{ span: 12 }" :md="{ span: 12 }" :sm="{ span: 24 }"
                         :xs="{ span: 24}"
                  >
                    <r-avatar data-src="/images/content/illustration-14-green.svg" :size="300" class="r-avatar-block"
                    ></r-avatar>
                  </a-col>
                </a-row>
              </a-col>
              ...
              >
                <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                  ...
                  >
                    <h4 class="r-heading">
                      Transforming
                      the way business is <span class="r-text-primary">experienced</span> online
                    </h4>
                  </a-col>
                  <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                         :sm="{ span: 24 }"
            ...
            <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
              ...
              >
                <p class="r-text-normal">
                  ...
                  At Shopple, we are building a business experience that helps millions of people be
        ...
        >
          <a-card class="r-bg-secondary-light">
            <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
              ...
              >
                <h4 class="r-heading">
                  Shopple as a specialist house with a <span class="r-text-blue">diverse</span>
                  team
                </h4>
              </a-col>
              <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
