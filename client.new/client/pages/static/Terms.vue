        ...
        <a-col :lg="{span: 24}" :md="{span: 24}" :sm="{span: 24}" :xs="{span: 24}">
          <article class="r-article">
            ...
            <p>If you are a Shopple Bookkeeping customer, you acknowledge and agree that in performing the Services,
              ...
              to your
              books may adversely impact Services previously performed by Shopple, causing Shopple to have to
              re-perform
              such
            ...
            <p>Subject to Section 3.2 (Disclosure of Confidential Information) the recipient (that is, Shopple and
              you)
              will
            ...
            <p>Shopple will collect payment for the fees automatically via ACH. Fees are exclusive of taxes, which
              ...
              to your
              business bank checking accounts on file with Shopple (using your business address on file) in order to
              pay
              amounts that you owe to Shopple (including for any Renewal Terms as those payments come due), and, if
              necessary,
              to initiate adjustments for any transactions credited or debited in error. Shopple may immediately
              suspend
            ...
            <p>Upon the end of the Initial Term and any Renewal Term, your subscription will automatically renew for the
              ...
              as
              applicable. If Shopple increases your subscription fees in connection with a renewal, we will provide
              you
              with
            ...
            <p>In the event your subscription ends, we will try to transfer to you the “master administrator” status for
              the
              Intuit Quickbooks Online account that was maintained for you by Shopple, so that you can elect to
              maintain
              that
            ...
            <p>Except as set forth in Section 11.5 (Arbitration), you and Shopple agree that any and all claims
              relating
              to
            ...
            <p>If you have a dispute with Shopple, you will promptly send written notice to: Shopple.com, Inc., PO
              Box
              7775
              #86889, South Africa, the Western Cape Government Shopple Inc.</p>
            ...
            <p>Shopple’s Affiliates and Shopple’s and its Affiliates’ resellers and distributors are intended third
              party
            ...
            <p>“<strong>Shopple</strong>”, “<strong>we</strong>”, and “<strong>us</strong>” means Shopple.com, Inc.
            </p>
