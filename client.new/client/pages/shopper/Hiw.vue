<template>
  <a-row :gutter="[48,96]" align="middle" justify="center" type="flex">
                    ...
                    <a-row :gutter="[24,24]" align="middle" justify="start" type="flex">
                      ...
                      >
                        <p class="r-text-medium">
                          Active Shopple shoppers handle all the business and delivery experiences for Shopple customers at a steady rate.
                        </p>
                      </a-col>
                      <a-col :lg="{ span: 24 }" :md="{ span: 24 }"
                             :sm="{ span: 24 }"
    ...
    <a-col :lg="{ span: 24 }" :md="{ span: 24 }" :sm="{ span: 24 }"
           ...
           class="r-text-center"
    >
      <r-tabs active-key="shopper" theme="shopper" title="Shopple connects shoppers to customers."></r-tabs>
    </a-col>
                  ...
                  <a-row :gutter="[24,24]" class="r-text-center" justify="center" type="flex">
                    <a-col :lg="{ span: 24 }" :sm="{ span: 24 }" :xs="{ span: 24 }">
                      <h3 class="r-heading-light r-text-uppercase">
                        Why <span class="r-text-primary">Shopple</span> for shoppers?
                      </h3>
                    </a-col>
