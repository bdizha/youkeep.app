          ...
          <a-row :gutter="[24, 24]" align="middle" justify="start" type="flex">
            ...
            <a-col :xs="{ span: 24 }" class="r-text-left">
              <p class="r-text-normal">
                ...
                spend
                with their families! Shopple members order business via the Shopple app and can have
                them
            ...
            <a-col :xs="{ span: 24 }" class="r-text-left">
              <p class="r-text-normal">
                Shopple Shoppers carefully select member's business using the Shopple app and deliver
                them
