      ...
      portfolio: [
        {
          title: 'Shopple',
          slug: 'Shopple',
          content: 'B2B platform connecting retailers and resellers for better product discovery.',
          problem: 'Retailers didn’t have a good mechanism to contact resellers, and when they did get proposals, the resellers often didn’t know what information the retailers needed to make a decision on their product.',
          solution: 'Empowering resellers and retailers to be productive and successful. Merchants can create free product profiles that detail all the key information buyers need to know when considering your product.'
        },
        {
          title: 'Shopple',
          slug: 'Shopple',
          ...
          solution: 'Shopple is designed to utilise technology to make high-quality selling tools affordable to everyone. We combine state-of-the-art technology with in-house expertise to reduce fees and maximize your long-term business connectons.\n'
        },
        {
          title: 'Finkipa',
          slug: 'finkipa',
