...
export default {
      ...
      userTypes: [
        {
          value: 1,
          label: 'shopper',
          content: 'I would like shop at Shopple for everyday items. like fashion, gadgets and more.'
        },
        {
          value: 3,
          label: 'merchant',
          content: 'I would like to sell products to millions of Shopple shoppers out there.'
        },
        {
          value: 4,
          label: 'business',
          content: 'We would like to do B2B transactions or partner up with Shopple.'
        }
      ],
      nextStep: 1,
      prevStep: null
  ...
  methods: {
    ...
    onSuccess () {
      ...
      this.$message.success('Thank you for signing up with us, ' + this.user.name + '. Enjoy your business with Shopple.')
    },
    onNextStep () {
